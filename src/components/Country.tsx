    ...
    <div className="w-full max-w-470 border border-solid border-grey-3 rounded-def">
      <figure className="w-full h-321 p-3 max-800:h-fit">
        <img
          ...
          className="w-full h-295 object-cover rounded-def max-800:h-fit"
        />
      </figure>

      <div className="w-full h-85 flex justify-between items-center bg-grey-2 border-t border-solid border-grey-3 py-5 px-11 rounded-b-def max-425:flex-col max-425:h-140 max-425:items-start">
